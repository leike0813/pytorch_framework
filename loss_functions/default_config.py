...
DEFAULT_CONFIG.ABBR.OrderedCrossEntropy = 'OCE'
DEFAULT_CONFIG.ABBR.PositionLoss = 'POS'
...
DEFAULT_CONFIG.SIDE_OUTPUT_WEIGHTS = []
...
DEFAULT_CONFIG.CELOSS.label_smoothing = 0.
...
DEFAULT_CONFIG.OCELOSS = CN(visible=False)
DEFAULT_CONFIG.OCELOSS.num_classes = 0 # invalid value, indicating that must be specified by user
DEFAULT_CONFIG.OCELOSS.class_values = [] # use class index as class value

DEFAULT_CONFIG.POSITIONLOSS = CN(visible=False)
DEFAULT_CONFIG.POSITIONLOSS.reduction = 'mean'
DEFAULT_CONFIG.POSITIONLOSS.normalize = True

DEFAULT_CONFIG.CUSTOM_ARGS = CN()